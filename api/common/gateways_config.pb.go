...
// EQueryDataFormat determines the format of the data returned by the YDB server
type TYdbDataSourceOptions_EQueryDataFormat int32

const (
	TYdbDataSourceOptions_QUERY_DATA_FORMAT_UNSPECIFIED TYdbDataSourceOptions_EQueryDataFormat = 0
	TYdbDataSourceOptions_ARROW                         TYdbDataSourceOptions_EQueryDataFormat = 1
)

// Enum value maps for TYdbDataSourceOptions_EQueryDataFormat.
var (
	TYdbDataSourceOptions_EQueryDataFormat_name = map[int32]string{
		0: "QUERY_DATA_FORMAT_UNSPECIFIED",
		1: "ARROW",
	}
	TYdbDataSourceOptions_EQueryDataFormat_value = map[string]int32{
		"QUERY_DATA_FORMAT_UNSPECIFIED": 0,
		"ARROW":                         1,
	}
)

func (x TYdbDataSourceOptions_EQueryDataFormat) Enum() *TYdbDataSourceOptions_EQueryDataFormat {
	p := new(TYdbDataSourceOptions_EQueryDataFormat)
	*p = x
	return p
}

func (x TYdbDataSourceOptions_EQueryDataFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TYdbDataSourceOptions_EQueryDataFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_yql_essentials_providers_common_proto_gateways_config_proto_enumTypes[5].Descriptor()
}

func (TYdbDataSourceOptions_EQueryDataFormat) Type() protoreflect.EnumType {
	return &file_yql_essentials_providers_common_proto_gateways_config_proto_enumTypes[5]
}

func (x TYdbDataSourceOptions_EQueryDataFormat) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TYdbDataSourceOptions_EQueryDataFormat.Descriptor instead.
func (TYdbDataSourceOptions_EQueryDataFormat) EnumDescriptor() ([]byte, []int) {
	return file_yql_essentials_providers_common_proto_gateways_config_proto_rawDescGZIP(), []int{12, 0}
}
...
func (x *TIcebergCatalog) GetHiveMetastore() *TIcebergCatalog_THiveMetastore {
	if x != nil {
		if x, ok := x.Payload.(*TIcebergCatalog_HiveMetastore); ok {
...
// TYdbDataSourceOptions represents settings specific for YDB data source
type TYdbDataSourceOptions struct {
	state           protoimpl.MessageState                 `protogen:"open.v1"`
	QueryDataFormat TYdbDataSourceOptions_EQueryDataFormat `protobuf:"varint,1,opt,name=query_data_format,json=queryDataFormat,proto3,enum=NYql.TYdbDataSourceOptions_EQueryDataFormat" json:"query_data_format,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *TYdbDataSourceOptions) Reset() {
	*x = TYdbDataSourceOptions{}
	mi := &file_yql_essentials_providers_common_proto_gateways_config_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TYdbDataSourceOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TYdbDataSourceOptions) ProtoMessage() {}

func (x *TYdbDataSourceOptions) ProtoReflect() protoreflect.Message {
	mi := &file_yql_essentials_providers_common_proto_gateways_config_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TYdbDataSourceOptions.ProtoReflect.Descriptor instead.
func (*TYdbDataSourceOptions) Descriptor() ([]byte, []int) {
	return file_yql_essentials_providers_common_proto_gateways_config_proto_rawDescGZIP(), []int{12}
}

func (x *TYdbDataSourceOptions) GetQueryDataFormat() TYdbDataSourceOptions_EQueryDataFormat {
	if x != nil {
		return x.QueryDataFormat
	}
...
type TGenericDataSourceInstance struct {
	...
	//	*TGenericDataSourceInstance_YdbOptions
...
func (*TGenericDataSourceInstance) Descriptor() ([]byte, []int) {
	return file_yql_essentials_providers_common_proto_gateways_config_proto_rawDescGZIP(), []int{13}
}
...
func (x *TGenericDataSourceInstance) GetYdbOptions() *TYdbDataSourceOptions {
	if x != nil {
		if x, ok := x.Options.(*TGenericDataSourceInstance_YdbOptions); ok {
			return x.YdbOptions
		}
	}
	return nil
...
type TGenericDataSourceInstance_YdbOptions struct {
	YdbOptions *TYdbDataSourceOptions `protobuf:"bytes,15,opt,name=ydb_options,json=ydbOptions,proto3,oneof"`
}
...
func (*TGenericDataSourceInstance_YdbOptions) isTGenericDataSourceInstance_Options() {}
...
func (x *TIcebergWarehouse_TS3) Reset() {
	*x = TIcebergWarehouse_TS3{}
	mi := &file_yql_essentials_providers_common_proto_gateways_config_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_yql_essentials_providers_common_proto_gateways_config_proto_rawDesc = string([]byte{
	...
	,
	...
	,
...
var file_yql_essentials_providers_common_proto_gateways_config_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_yql_essentials_providers_common_proto_gateways_config_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_yql_essentials_providers_common_proto_gateways_config_proto_goTypes = []any{
	...
	(TYdbDataSourceOptions_EQueryDataFormat)(0),                // 5: NYql.TYdbDataSourceOptions.EQueryDataFormat
	(*TGenericEndpoint)(nil),                                   // 6: NYql.TGenericEndpoint
	(*TGenericCredentials)(nil),                                // 7: NYql.TGenericCredentials
	(*TPostgreSQLDataSourceOptions)(nil),                       // 8: NYql.TPostgreSQLDataSourceOptions
	(*TClickhouseDataSourceOptions)(nil),                       // 9: NYql.TClickhouseDataSourceOptions
	(*TS3DataSourceOptions)(nil),                               // 10: NYql.TS3DataSourceOptions
	(*TGreenplumDataSourceOptions)(nil),                        // 11: NYql.TGreenplumDataSourceOptions
	(*TOracleDataSourceOptions)(nil),                           // 12: NYql.TOracleDataSourceOptions
	(*TLoggingDataSourceOptions)(nil),                          // 13: NYql.TLoggingDataSourceOptions
	(*TMongoDbDataSourceOptions)(nil),                          // 14: NYql.TMongoDbDataSourceOptions
	(*TIcebergCatalog)(nil),                                    // 15: NYql.TIcebergCatalog
	(*TIcebergWarehouse)(nil),                                  // 16: NYql.TIcebergWarehouse
	(*TIcebergDataSourceOptions)(nil),                          // 17: NYql.TIcebergDataSourceOptions
	(*TYdbDataSourceOptions)(nil),                              // 18: NYql.TYdbDataSourceOptions
	(*TGenericDataSourceInstance)(nil),                         // 19: NYql.TGenericDataSourceInstance
	(*TGenericCredentials_TBasic)(nil),                         // 20: NYql.TGenericCredentials.TBasic
	(*TGenericCredentials_TToken)(nil),                         // 21: NYql.TGenericCredentials.TToken
	(*TIcebergCatalog_THadoop)(nil),                            // 22: NYql.TIcebergCatalog.THadoop
	(*TIcebergCatalog_THiveMetastore)(nil),                     // 23: NYql.TIcebergCatalog.THiveMetastore
	(*TIcebergWarehouse_TS3)(nil),                              // 24: NYql.TIcebergWarehouse.TS3
}
var file_yql_essentials_providers_common_proto_gateways_config_proto_depIdxs = []int32{
	20, // 0: NYql.TGenericCredentials.basic:type_name -> NYql.TGenericCredentials.TBasic
	21, // 1: NYql.TGenericCredentials.token:type_name -> NYql.TGenericCredentials.TToken
	...
	22, // 5: NYql.TIcebergCatalog.hadoop:type_name -> NYql.TIcebergCatalog.THadoop
	23, // 6: NYql.TIcebergCatalog.hive_metastore:type_name -> NYql.TIcebergCatalog.THiveMetastore
	24, // 7: NYql.TIcebergWarehouse.s3:type_name -> NYql.TIcebergWarehouse.TS3
	15, // 8: NYql.TIcebergDataSourceOptions.catalog:type_name -> NYql.TIcebergCatalog
	16, // 9: NYql.TIcebergDataSourceOptions.warehouse:type_name -> NYql.TIcebergWarehouse
	5,  // 10: NYql.TYdbDataSourceOptions.query_data_format:type_name -> NYql.TYdbDataSourceOptions.EQueryDataFormat
	0,  // 11: NYql.TGenericDataSourceInstance.kind:type_name -> NYql.EGenericDataSourceKind
	6,  // 12: NYql.TGenericDataSourceInstance.endpoint:type_name -> NYql.TGenericEndpoint
	7,  // 13: NYql.TGenericDataSourceInstance.credentials:type_name -> NYql.TGenericCredentials
	1,  // 14: NYql.TGenericDataSourceInstance.protocol:type_name -> NYql.EGenericProtocol
	8,  // 15: NYql.TGenericDataSourceInstance.pg_options:type_name -> NYql.TPostgreSQLDataSourceOptions
	9,  // 16: NYql.TGenericDataSourceInstance.ch_options:type_name -> NYql.TClickhouseDataSourceOptions
	10, // 17: NYql.TGenericDataSourceInstance.s3_options:type_name -> NYql.TS3DataSourceOptions
	11, // 18: NYql.TGenericDataSourceInstance.gp_options:type_name -> NYql.TGreenplumDataSourceOptions
	12, // 19: NYql.TGenericDataSourceInstance.oracle_options:type_name -> NYql.TOracleDataSourceOptions
	13, // 20: NYql.TGenericDataSourceInstance.logging_options:type_name -> NYql.TLoggingDataSourceOptions
	14, // 21: NYql.TGenericDataSourceInstance.mongodb_options:type_name -> NYql.TMongoDbDataSourceOptions
	17, // 22: NYql.TGenericDataSourceInstance.iceberg_options:type_name -> NYql.TIcebergDataSourceOptions
	18, // 23: NYql.TGenericDataSourceInstance.ydb_options:type_name -> NYql.TYdbDataSourceOptions
...
func file_yql_essentials_providers_common_proto_gateways_config_proto_init() {
	...
	file_yql_essentials_providers_common_proto_gateways_config_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*TGenericDataSourceInstance_YdbOptions)(nil),
	}
	type x struct{}
