...
func (x *TExpression) GetUnwrap() *TExpression_TUnwrap {
	if x != nil {
		if x, ok := x.Payload.(*TExpression_Unwrap); ok {
			return x.Unwrap
		}
	}
	return nil
...
func (x *TExpression) GetMinOf() *TExpression_TMinOf {
	if x != nil {
		if x, ok := x.Payload.(*TExpression_MinOf); ok {
			return x.MinOf
		}
	}
	return nil
...
func (x *TExpression) GetMaxOf() *TExpression_TMaxOf {
	if x != nil {
		if x, ok := x.Payload.(*TExpression_MaxOf); ok {
			return x.MaxOf
		}
	}
	return nil
...
func (x *TExpression) GetCurrentUtcTimestamp() *TExpression_TCurrentUtcTimestamp {
	if x != nil {
		if x, ok := x.Payload.(*TExpression_CurrentUtcTimestamp); ok {
...
func file_ydb_library_yql_providers_generic_connector_api_service_protos_connector_proto_init() {
	...
	file_ydb_library_yql_providers_generic_connector_api_service_protos_connector_proto_msgTypes[19].OneofWrappers = []any{
