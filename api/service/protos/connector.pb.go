...
const file_ydb_library_yql_providers_generic_connector_api_service_protos_connector_proto_rawDesc = "" +
	"\n" +
	"Nydb/library/yql/providers/generic/connector/api/service/protos/connector.proto\x12\x14NYql.NConnector.NApi\x1a%ydb/public/api/protos/ydb_value.proto\x1a,ydb/public/api/protos/ydb_status_codes.proto\x1a-ydb/public/api/protos/ydb_issue_message.proto\x1a;yql/essentials/providers/common/proto/gateways_config.proto\"\x95\x01\n" +
	"\x12TListTablesRequest\x12R\n" +
	"\x14data_source_instance\x18\x01 \x01(\v2 .NYql.TGenericDataSourceInstanceR\x12dataSourceInstance\x12\x1a\n" +
	"\apattern\x18\x02 \x01(\tH\x00R\apattern:\x02\x18\x01B\v\n" +
	"\tfiltering\"e\n" +
	"\x13TListTablesResponse\x12\x16\n" +
	"\x06tables\x18\x01 \x03(\tR\x06tables\x122\n" +
	"\x05error\x18d \x01(\v2\x1c.NYql.NConnector.NApi.TErrorR\x05error:\x02\x18\x01\"\xe1\x01\n" +
	"\x15TDescribeTableRequest\x12R\n" +
	"\x14data_source_instance\x18\x01 \x01(\v2 .NYql.TGenericDataSourceInstanceR\x12dataSourceInstance\x12\x14\n" +
	"\x05table\x18\x02 \x01(\tR\x05table\x12^\n" +
	"\x15type_mapping_settings\x18\x03 \x01(\v2*.NYql.NConnector.NApi.TTypeMappingSettingsR\x13typeMappingSettings\"g\n" +
	"\x14TTypeMappingSettings\x12O\n" +
	"\x10date_time_format\x18\x01 \x01(\x0e2%.NYql.NConnector.NApi.EDateTimeFormatR\x0edateTimeFormat\"\x83\x01\n" +
	"\x16TDescribeTableResponse\x125\n" +
	"\x06schema\x18\x01 \x01(\v2\x1d.NYql.NConnector.NApi.TSchemaR\x06schema\x122\n" +
	"\x05error\x18d \x01(\v2\x1c.NYql.NConnector.NApi.TErrorR\x05error\"0\n" +
	"\aTSchema\x12%\n" +
	"\acolumns\x18\x01 \x03(\v2\v.Ydb.ColumnR\acolumns\"\xc8\x01\n" +
	"\x12TListSplitsRequest\x127\n" +
	"\aselects\x18\x02 \x03(\v2\x1d.NYql.NConnector.NApi.TSelectR\aselects\x12&\n" +
	"\x0fmax_split_count\x18\x03 \x01(\rR\rmaxSplitCount\x12\x1d\n" +
	"\n" +
	"split_size\x18\x04 \x01(\x04R\tsplitSize\x12,\n" +
	"\x12split_number_limit\x18\x05 \x01(\x04R\x10splitNumberLimitJ\x04\b\x01\x10\x02\"\x7f\n" +
	"\x13TListSplitsResponse\x124\n" +
	"\x06splits\x18\x01 \x03(\v2\x1c.NYql.NConnector.NApi.TSplitR\x06splits\x122\n" +
	"\x05error\x18d \x01(\v2\x1c.NYql.NConnector.NApi.TErrorR\x05error\"\xe8\x05\n" +
	"\aTSelect\x12R\n" +
	"\x14data_source_instance\x18\x01 \x01(\v2 .NYql.TGenericDataSourceInstanceR\x12dataSourceInstance\x127\n" +
	"\x04what\x18\x02 \x01(\v2#.NYql.NConnector.NApi.TSelect.TWhatR\x04what\x127\n" +
	"\x04from\x18\x03 \x01(\v2#.NYql.NConnector.NApi.TSelect.TFromR\x04from\x12:\n" +
	"\x05where\x18\x04 \x01(\v2$.NYql.NConnector.NApi.TSelect.TWhereR\x05where\x12:\n" +
	"\x05limit\x18\x05 \x01(\v2$.NYql.NConnector.NApi.TSelect.TLimitR\x05limit\x12N\n" +
	"\x11predefined_schema\x18\x06 \x01(\v2\x1d.NYql.NConnector.NApi.TSchemaB\x02\x18\x01R\x10predefinedSchema\x1a\x83\x01\n" +
	"\x05TWhat\x12?\n" +
	"\x05items\x18\x01 \x03(\v2).NYql.NConnector.NApi.TSelect.TWhat.TItemR\x05items\x1a9\n" +
	"\x05TItem\x12%\n" +
	"\x06column\x18\x01 \x01(\v2\v.Ydb.ColumnH\x00R\x06columnB\t\n" +
	"\apayload\x1a<\n" +
	"\x05TFrom\x12\x14\n" +
	"\x05table\x18\x01 \x01(\tR\x05table\x12\x1d\n" +
	"\n" +
	"object_key\x18\x02 \x01(\tR\tobjectKey\x1aS\n" +
	"\x06TWhere\x12C\n" +
	"\ffilter_typed\x18\x01 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\vfilterTypedJ\x04\b\x02\x10\x03\x1a6\n" +
	"\x06TLimit\x12\x14\n" +
	"\x05limit\x18\x01 \x01(\x04R\x05limit\x12\x16\n" +
	"\x06offset\x18\x02 \x01(\x04R\x06offset\"~\n" +
	"\x06TSplit\x125\n" +
	"\x06select\x18\x01 \x01(\v2\x1d.NYql.NConnector.NApi.TSelectR\x06select\x12\"\n" +
	"\vdescription\x18\x02 \x01(\fH\x00R\vdescription\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\x04R\x02idB\t\n" +
	"\apayload\"\xa9\x05\n" +
	"\x12TReadSplitsRequest\x12V\n" +
	"\x14data_source_instance\x18\x01 \x01(\v2 .NYql.TGenericDataSourceInstanceB\x02\x18\x01R\x12dataSourceInstance\x124\n" +
	"\x06splits\x18\x02 \x03(\v2\x1c.NYql.NConnector.NApi.TSplitR\x06splits\x12B\n" +
	"\x04mode\x18\x03 \x01(\x0e2..NYql.NConnector.NApi.TReadSplitsRequest.EModeR\x04mode\x12H\n" +
	"\x06format\x18\x04 \x01(\x0e20.NYql.NConnector.NApi.TReadSplitsRequest.EFormatR\x06format\x12G\n" +
	"\fcontinuation\x18\x06 \x01(\v2#.NYql.NConnector.NApi.TContinuationR\fcontinuation\x12Q\n" +
	"\tfiltering\x18\a \x01(\x0e23.NYql.NConnector.NApi.TReadSplitsRequest.EFilteringR\tfiltering\"9\n" +
	"\x05EMode\x12\x14\n" +
	...
	"\x13ARROW_IPC_STREAMING\x10\x02\"\x04\b\x01\x10\x01\"X\n" +
	"\n" +
	"EFiltering\x12\x19\n" +
	"\x15FILTERING_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12FILTERING_OPTIONAL\x10\x01\x12\x17\n" +
	"\x13FILTERING_MANDATORY\x10\x02J\x04\b\x05\x10\x06\"\xfd\x04\n" +
	"\x13TReadSplitsResponse\x12U\n" +
	"\n" +
	"column_set\x18\x01 \x01(\v24.NYql.NConnector.NApi.TReadSplitsResponse.TColumnSetH\x00R\tcolumnSet\x120\n" +
	"\x13arrow_ipc_streaming\x18\x02 \x01(\fH\x00R\x11arrowIpcStreaming\x12,\n" +
	"\x12split_index_number\x18\x03 \x01(\rR\x10splitIndexNumber\x12G\n" +
	"\fcontinuation\x18\x04 \x01(\v2#.NYql.NConnector.NApi.TContinuationR\fcontinuation\x12F\n" +
	"\x05stats\x18\x05 \x01(\v20.NYql.NConnector.NApi.TReadSplitsResponse.TStatsR\x05stats\x122\n" +
	"\x05error\x18d \x01(\v2\x1c.NYql.NConnector.NApi.TErrorR\x05error\x1a\xaa\x01\n" +
	"\n" +
	"TColumnSet\x12\x1f\n" +
	"\x04meta\x18\x01 \x03(\v2\v.Ydb.ColumnR\x04meta\x12P\n" +
	"\x04data\x18\x02 \x03(\v2<.NYql.NConnector.NApi.TReadSplitsResponse.TColumnSet.TColumnR\x04data\x1a)\n" +
	"\aTColumn\x12\x1e\n" +
	"\x04data\x18\x01 \x03(\v2\n" +
	".Ydb.ValueR\x04data\x1a2\n" +
	"\x06TStats\x12\x12\n" +
	"\x04rows\x18\x01 \x01(\x04R\x04rows\x12\x14\n" +
	"\x05bytes\x18\x02 \x01(\x04R\x05bytesB\t\n" +
	"\apayload\">\n" +
	"\rTContinuation\x12\"\n" +
	"\vdescription\x18\x01 \x01(\fH\x00R\vdescriptionB\t\n" +
	"\apayload\"\x82\n" +
	"\n" +
	"\vTExpression\x122\n" +
	"\vtyped_value\x18\x01 \x01(\v2\x0f.Ydb.TypedValueH\x00R\n" +
	"typedValue\x12\x18\n" +
	"\x06column\x18\x02 \x01(\tH\x00R\x06column\x12t\n" +
	"\x17arithmetical_expression\x18\x03 \x01(\v29.NYql.NConnector.NApi.TExpression.TArithmeticalExpressionH\x00R\x16arithmeticalExpression\x12=\n" +
	"\x04null\x18\x04 \x01(\v2'.NYql.NConnector.NApi.TExpression.TNullH\x00R\x04null\x12I\n" +
	"\bcoalesce\x18\x05 \x01(\v2+.NYql.NConnector.NApi.TExpression.TCoalesceH\x00R\bcoalesce\x127\n" +
	"\x02if\x18\x06 \x01(\v2%.NYql.NConnector.NApi.TExpression.TIfH\x00R\x02if\x12=\n" +
	"\x04cast\x18\a \x01(\v2'.NYql.NConnector.NApi.TExpression.TCastH\x00R\x04cast\x1a\x8b\x03\n" +
	"\x17TArithmeticalExpression\x12b\n" +
	"\toperation\x18\x01 \x01(\x0e2D.NYql.NConnector.NApi.TExpression.TArithmeticalExpression.EOperationR\toperation\x12@\n" +
	"\n" +
	"left_value\x18\x02 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\tleftValue\x12B\n" +
	"\vright_value\x18\x03 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\n" +
	"rightValue\"\x85\x01\n" +
	"\n" +
	"EOperation\x12$\n" +
	" EXPRESSION_OPERATION_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03MUL\x10\x01\x12\a\n" +
	"\x03ADD\x10\x02\x12\a\n" +
	"\x03SUB\x10\x03\x12\a\n" +
	"\x03DIV\x10\a\x12\a\n" +
	"\x03MOD\x10\b\x12\v\n" +
	"\aBIT_AND\x10\x04\x12\n" +
	"\n" +
	"\x06BIT_OR\x10\x05\x12\v\n" +
	"\aBIT_XOR\x10\x06\x1aJ\n" +
	"\tTCoalesce\x12=\n" +
	"\boperands\x18\x01 \x03(\v2!.NYql.NConnector.NApi.TExpressionR\boperands\x1a\xdd\x01\n" +
	"\x03TIf\x12>\n" +
	"\tpredicate\x18\x01 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\tpredicate\x12J\n" +
	"\x0fthen_expression\x18\x02 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x0ethenExpression\x12J\n" +
	"\x0felse_expression\x18\x03 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x0eelseExpression\x1a_\n" +
	"\x05TCast\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x12\x1d\n" +
	"\x04type\x18\x02 \x01(\v2\t.Ydb.TypeR\x04type\x1a\a\n" +
	"\x05TNullB\t\n" +
	"\apayload\"\x82\x13\n" +
	"\n" +
	"TPredicate\x12H\n" +
	"\bnegation\x18\x01 \x01(\v2*.NYql.NConnector.NApi.TPredicate.TNegationH\x00R\bnegation\x12Q\n" +
	"\vconjunction\x18\x02 \x01(\v2-.NYql.NConnector.NApi.TPredicate.TConjunctionH\x00R\vconjunction\x12Q\n" +
	"\vdisjunction\x18\x03 \x01(\v2-.NYql.NConnector.NApi.TPredicate.TDisjunctionH\x00R\vdisjunction\x12E\n" +
	"\abetween\x18\x04 \x01(\v2).NYql.NConnector.NApi.TPredicate.TBetweenH\x00R\abetween\x126\n" +
	"\x02in\x18\x05 \x01(\v2$.NYql.NConnector.NApi.TPredicate.TInH\x00R\x02in\x12C\n" +
	"\ais_null\x18\x06 \x01(\v2(.NYql.NConnector.NApi.TPredicate.TIsNullH\x00R\x06isNull\x12M\n" +
	"\vis_not_null\x18\a \x01(\v2+.NYql.NConnector.NApi.TPredicate.TIsNotNullH\x00R\tisNotNull\x12N\n" +
	"\n" +
	"comparison\x18\b \x01(\v2,.NYql.NConnector.NApi.TPredicate.TComparisonH\x00R\n" +
	"comparison\x12[\n" +
	"\x0fbool_expression\x18\t \x01(\v20.NYql.NConnector.NApi.TPredicate.TBoolExpressionH\x00R\x0eboolExpression\x12H\n" +
	"\bcoalesce\x18\n" +
	" \x01(\v2*.NYql.NConnector.NApi.TPredicate.TCoalesceH\x00R\bcoalesce\x126\n" +
	"\x02if\x18\v \x01(\v2$.NYql.NConnector.NApi.TPredicate.TIfH\x00R\x02if\x12B\n" +
	"\x06regexp\x18\f \x01(\v2(.NYql.NConnector.NApi.TPredicate.TRegexpH\x00R\x06regexp\x1aG\n" +
	"\tTNegation\x12:\n" +
	"\aoperand\x18\x01 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\aoperand\x1aL\n" +
	"\fTConjunction\x12<\n" +
	"\boperands\x18\x01 \x03(\v2 .NYql.NConnector.NApi.TPredicateR\boperands\x1aL\n" +
	"\fTDisjunction\x12<\n" +
	"\boperands\x18\x01 \x03(\v2 .NYql.NConnector.NApi.TPredicateR\boperands\x1aI\n" +
	"\tTCoalesce\x12<\n" +
	"\boperands\x18\x01 \x03(\v2 .NYql.NConnector.NApi.TPredicateR\boperands\x1a\xd7\x01\n" +
	"\x03TIf\x12>\n" +
	"\tpredicate\x18\x01 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\tpredicate\x12G\n" +
	"\x0ethen_predicate\x18\x02 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\rthenPredicate\x12G\n" +
	"\x0eelse_predicate\x18\x03 \x01(\v2 .NYql.NConnector.NApi.TPredicateR\relsePredicate\x1a\xbb\x01\n" +
	"\bTBetween\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x127\n" +
	"\x05least\x18\x02 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05least\x12=\n" +
	"\bgreatest\x18\x03 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\bgreatest\x1as\n" +
	"\x03TIn\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x123\n" +
	"\x03set\x18\x02 \x03(\v2!.NYql.NConnector.NApi.TExpressionR\x03set\x1aB\n" +
	"\aTIsNull\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x1aE\n" +
	"\n" +
	"TIsNotNull\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x1aJ\n" +
	"\x0fTBoolExpression\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x1a\xdd\x02\n" +
	"\vTComparison\x12U\n" +
	"\toperation\x18\x01 \x01(\x0e27.NYql.NConnector.NApi.TPredicate.TComparison.EOperationR\toperation\x12@\n" +
	"\n" +
	"left_value\x18\x02 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\tleftValue\x12B\n" +
	"\vright_value\x18\x03 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\n" +
	"rightValue\"q\n" +
	"\n" +
	"EOperation\x12$\n" +
	" COMPARISON_OPERATION_UNSPECIFIED\x10\x00\x12\x05\n" +
	"\x01L\x10\x01\x12\x06\n" +
	"\x02LE\x10\x02\x12\x06\n" +
	"\x02EQ\x10\x03\x12\x06\n" +
	"\x02NE\x10\x04\x12\x06\n" +
	"\x02GE\x10\x05\x12\x05\n" +
	"\x01G\x10\x06\x12\a\n" +
	"\x03IND\x10\a\x12\x06\n" +
	"\x02ID\x10\b\x1a\x7f\n" +
	"\aTRegexp\x127\n" +
	"\x05value\x18\x01 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\x05value\x12;\n" +
	"\apattern\x18\x02 \x01(\v2!.NYql.NConnector.NApi.TExpressionR\apatternB\t\n" +
	"\apayload\"\x86\x01\n" +
	"\x06TError\x121\n" +
	"\x06status\x18\x01 \x01(\x0e2\x19.Ydb.StatusIds.StatusCodeR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12/\n" +
	"\x06issues\x18\x03 \x03(\v2\x17.Ydb.Issue.IssueMessageR\x06issues*V\n" +
	"\x0fEDateTimeFormat\x12 \n" +
	"\x1cDATE_TIME_FORMAT_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rSTRING_FORMAT\x10\x01\x12\x0e\n" +
	"\n" +
	"YQL_FORMAT\x10\x02B<Z:github.com/ydb-platform/fq-connector-go/api/service/protosb\x06proto3"
