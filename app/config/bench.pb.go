...
const file_app_config_bench_proto_rawDesc = "" +
	"\n" +
	"\x16app/config/bench.proto\x12\x19NYql.Connector.App.Config\x1a;yql/essentials/providers/common/proto/gateways_config.proto\x1a\x17app/config/client.proto\x1a\x17app/config/server.proto\"\x93\x03\n" +
	"\x10TBenchmarkConfig\x12O\n" +
	"\rserver_remote\x18\x01 \x01(\v2(.NYql.Connector.App.Config.TClientConfigH\x00R\fserverRemote\x12M\n" +
	"\fserver_local\x18\x02 \x01(\v2(.NYql.Connector.App.Config.TServerConfigH\x00R\vserverLocal\x12R\n" +
	"\x14data_source_instance\x18\x03 \x01(\v2 .NYql.TGenericDataSourceInstanceR\x12dataSourceInstance\x12\x14\n" +
	"\x05table\x18\x04 \x01(\tR\x05table\x12L\n" +
	"\n" +
	"test_cases\x18\x05 \x03(\v2-.NYql.Connector.App.Config.TBenchmarkTestCaseR\ttestCases\x12\x1d\n" +
	"\n" +
	"result_dir\x18\x06 \x01(\tR\tresultDirB\b\n" +
	"\x06server\"\xde\x01\n" +
	"\x12TBenchmarkTestCase\x12V\n" +
	"\rserver_params\x18\x01 \x01(\v21.NYql.Connector.App.Config.TBenchmarkServerParamsR\fserverParams\x12V\n" +
	"\rclient_params\x18\x03 \x01(\v21.NYql.Connector.App.Config.TBenchmarkClientParamsR\fclientParams\x12\x18\n" +
	"\acolumns\x18\x02 \x03(\tR\acolumns\"Z\n" +
	"\x16TBenchmarkServerParams\x12@\n" +
	"\x06paging\x18\x01 \x01(\v2(.NYql.Connector.App.Config.TPagingConfigR\x06paging\"b\n" +
	"\x16TBenchmarkClientParams\x12,\n" +
	"\x12queries_per_second\x18\x01 \x01(\x02R\x10queriesPerSecond\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\tR\bdurationB4Z2github.com/ydb-platform/fq-connector-go/app/configb\x06proto3"
