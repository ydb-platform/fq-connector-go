...
const file_app_config_server_proto_rawDesc = "" +
	...
	"\x13exponential_backoff\x18\n" +
	" \x01(\v24.NYql.Connector.App.Config.TExponentialBackoffConfigR\x12exponentialBackoff\x12F\n" +
	"\bpushdown\x18\v \x01(\v2*.NYql.Connector.App.Config.TPushdownConfigR\bpushdown\"\xa5\x02\n" +
	...
	"\x13exponential_backoff\x18\n" +
	" \x01(\v24.NYql.Connector.App.Config.TExponentialBackoffConfigR\x12exponentialBackoff\"\xeb\x01\n" +
	"\fTRedisConfig\x126\n" +
	"\x17ping_connection_timeout\x18\x02 \x01(\tR\x15pingConnectionTimeout\x12<\n" +
	"\x1bcount_docs_to_deduce_schema\x18\x03 \x01(\rR\x17countDocsToDeduceSchema\x12e\n" +
	"\x13exponential_backoff\x18\n" +
	...
	"\x05redis\x18\n" +
	" \x01(\v2'.NYql.Connector.App.Config.TRedisConfigR\x05redis*K\n" +
	"\tELogLevel\x12\t\n" +
