...
import (
	...
	"github.com/ydb-platform/fq-connector-go/app/server/datasource/rdbms/clickhouse/utils"
	"github.com/ydb-platform/fq-connector-go/common"
)

//nolint:funlen,gocyclo
func appendAcceptorAppenderFromSQLTypeNameNullable(
	typeName string,
	ydbType *Ydb.Type,
	acceptors []any,
	...
	case typeName == utils.String, tm.isFixedString.MatchString(typeName):
