...
var file_app_server_datasource_rdbms_logging_split_proto_goTypes = []interface{}{
...
func file_app_server_datasource_rdbms_logging_split_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_server_datasource_rdbms_logging_split_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_app_server_datasource_rdbms_logging_split_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TSplitDescription_TYdb); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_app_server_datasource_rdbms_logging_split_proto_msgTypes[0].OneofWrappers = []interface{}{
