...
const file_app_server_datasource_rdbms_logging_split_proto_rawDesc = "" +
	"\n" +
	"/app/server/datasource/rdbms/logging/split.proto\x122NYql.Connector.App.Server.DataSource.RDBMS.Logging\x1a;yql/essentials/providers/common/proto/gateways_config.proto\"\xfe\x01\n" +
	"\x11TSplitDescription\x12^\n" +
	"\x03ydb\x18\x01 \x01(\v2J.NYql.Connector.App.Server.DataSource.RDBMS.Logging.TSplitDescription.TYdbH\x00R\x03ydb\x1a~\n" +
	"\x04TYdb\x122\n" +
	"\bendpoint\x18\x01 \x01(\v2\x16.NYql.TGenericEndpointR\bendpoint\x12#\n" +
	"\rdatabase_name\x18\x02 \x01(\tR\fdatabaseName\x12\x1d\n" +
	"\n" +
	"table_name\x18\x03 \x01(\tR\ttableNameB\t\n" +
