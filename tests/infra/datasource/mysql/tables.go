		...
		Records: []*test_utils.Record{
			{
				Columns: map[string]any{
					...
					"col_14_datetime": []*uint64{
						ptr.Uint64(common.MustTimeToYDBType(common.TimeToYDBTimestamp, time.Date(1988, 11, 20, 12, 34, 56, 777777000, time.UTC))),
						ptr.Uint64(common.MustTimeToYDBType(common.TimeToYDBTimestamp, time.Date(2024, 07, 01, 01, 02, 03, 444444000, time.UTC))),
						nil,
					},
					...
					"col_18_tinytext":   []*[]byte{ptr.T([]byte("az")), ptr.T([]byte("буки")), nil},
					"col_19_text":       []*[]byte{ptr.T([]byte("az")), ptr.T([]byte("буки")), nil},
					"col_20_mediumtext": []*[]byte{ptr.T([]byte("az")), ptr.T([]byte("буки")), nil},
					"col_21_longtext":   []*[]byte{ptr.T([]byte("az")), ptr.T([]byte("буки")), nil},
					"col_22_binary":     []*string{ptr.String("az\x00\x00\x00\x00\x00\x00"), ptr.String("буки"), nil},
					"col_23_varbinary":  []*string{ptr.String("az"), ptr.String("буки"), nil},
					...
					"col_28_bool":       []*uint8{ptr.Uint8(1), ptr.Uint8(0), nil},
				},
			},
		},
	},
