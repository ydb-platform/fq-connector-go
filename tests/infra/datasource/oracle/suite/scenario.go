...
func TestPositiveStats(s *SuiteOracle, dataSource *datasource.DataSource, table *test_utils_oracle.Table) {
...
func TestMissingDataSource(s *SuiteOracle, dsi *api_common.TDataSourceInstance) {
	// read some table to "heat" metrics
...
func TestInvalidLogin(s *SuiteOracle, dsiSrc *api_common.TDataSourceInstance, table *test_utils_oracle.Table) {
...
func TestInvalidPassword(s *SuiteOracle, dsiSrc *api_common.TDataSourceInstance, table *test_utils_oracle.Table) {
	dsi := proto.Clone(dsiSrc).(*api_common.TDataSourceInstance)
...
func TestInvalidServiceName(s *SuiteOracle, dsiSrc *api_common.TDataSourceInstance, table *test_utils_oracle.Table) {
	dsi := proto.Clone(dsiSrc).(*api_common.TDataSourceInstance)
	oraOptions := dsi.Options.(*api_common.TDataSourceInstance_OraOptions)

	oraOptions.OraOptions.ServiceName = "wrong"
